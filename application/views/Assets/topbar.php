<div section="nav" class="c-siteHeader g-outer-spacing-bottom-large">
        <div class="c-siteHeader_grid g-grid-container">
          <div section="logo" class="c-siteLogo"><a href="/" rel="follow" aria-label="Download.com"><svg
                class="c-siteLogo_image c-siteLogo_image-medium g-fill-white">
                <use xlink:href="#logo"></use>
              </svg></a></div>
          <div class="c-searchBox_autoSuggest">
            <form><button type="submit" class="c-searchBox_autoSuggest_button"><svg
                  class="c-searchBox_autoSuggest_magGlass">
                  <use xlink:href="#mag"></use>
                </svg></button>
              <div class="c-searchBox_autoSuggest_inputBox"></div> <input id="c-searchBox_autoSuggest_id" type="text"
                placeholder="Search Apps..." value="" class="c-searchBox_autoSuggest_inputElement">
            </form>
        </div>
